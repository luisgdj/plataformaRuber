...
const RadiologiaConvencional = () => (
  <div className="zona-interactiva">
    ...
    <section>
      ...
      <video controls src="/videos/RadiologiaConvencional.mp4" />
    </section>

    <section>
      <h2>Documentación</h2>
      <a href="/docs/RadiologiaConvencional.pdf" target="_blank" rel="noopener noreferrer">
        Ver protocolo PDF
      </a>
    </section>
