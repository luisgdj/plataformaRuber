...
const GammaCamara = () => (
  <div className="zona-interactiva">
    ...
    <section>
      ...
      <video controls src="/videos/Gamma cámara.mp4" />
    </section>

    <section>
      <h2>Documentación</h2>
      <a href="/docs/Gamma_Camara.pdf" target="_blank" rel="noopener noreferrer">
        Ver protocolo PDF
      </a>
    </section>
    ...
    <section>
      ...
      <p>¿Qué tipo de radiación detecta la gamma cámara?</p>
