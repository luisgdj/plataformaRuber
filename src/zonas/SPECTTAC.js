...
const SPECTTAC = () => (
  <div className="zona-interactiva">
    <h1>Tomografía Computarizada por Emisión de Fotón Único (SPECT-TAC)</h1>
    ...
    <section>
      ...
      <video controls src="/videos/SPECTTAC.mp4" />
    </section>

    <section>
      <h2>Documentación</h2>
      <a href="/docs/SPECTTAC.pdf" target="_blank" rel="noopener noreferrer">
        Ver protocolo PDF
      </a>
    </section>
